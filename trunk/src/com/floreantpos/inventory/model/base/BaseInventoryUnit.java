...
public abstract class BaseInventoryUnit  implements Comparable, Serializable {
	...
	public boolean equals (Object obj) {
		...
		if (!(obj instanceof com.floreantpos.inventory.model.InventoryUnit)) return false;
		else {
			com.floreantpos.inventory.model.InventoryUnit inventoryUnit = (com.floreantpos.inventory.model.InventoryUnit) obj;
