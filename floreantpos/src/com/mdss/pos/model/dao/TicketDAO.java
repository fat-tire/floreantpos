...
import com.mdss.pos.model.util.TicketSummary;
...
public class TicketDAO extends BaseTicketDAO {
	...
	public void voidTicket(Ticket ticket) throws Exception {
		...
		try {
			...
			Criteria criteria = session.createCriteria(com.mdss.pos.model.PosTransaction.class);
			criteria.add(Restrictions.eq(com.mdss.pos.model.PosTransaction.PROP_TICKET, ticket));
			List list = criteria.list();
	...
	//	public void saveTransaction(Ticket ticket, com.mdss.pos.model.PosTransaction transaction, Terminal terminal, User user) throws Exception {
	//		Session session = null;
	//    	Transaction tx = null;
	//    	try {
