...
public abstract class BaseUserType  implements Comparable, Serializable {
	...
	// collections
	private java.util.Set<com.mdss.pos.model.UserPermission> permissions;
	 ...
	 */
	public java.util.Set<com.mdss.pos.model.UserPermission> getPermissions () {
			return permissions;
	}
	 ...
	 */
	public void setPermissions (java.util.Set<com.mdss.pos.model.UserPermission> permissions) {
		this.permissions = permissions;
	}

	public void addTopermissions (com.mdss.pos.model.UserPermission userPermission) {
		if (null == getPermissions()) setPermissions(new java.util.TreeSet<com.mdss.pos.model.UserPermission>());
	...
	public boolean equals (Object obj) {
		...
		if (!(obj instanceof com.mdss.pos.model.UserType)) return false;
		else {
			com.mdss.pos.model.UserType userType = (com.mdss.pos.model.UserType) obj;
