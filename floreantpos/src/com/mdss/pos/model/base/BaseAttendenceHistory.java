...
public abstract class BaseAttendenceHistory  implements Comparable, Serializable {
	...
	// many to one
	private com.mdss.pos.model.User user;
	 ...
	 */
	public com.mdss.pos.model.User getUser () {
			return user;
	}
	 ...
	 */
	public void setUser (com.mdss.pos.model.User user) {
		this.user = user;
	}
	...
	public boolean equals (Object obj) {
		...
		if (!(obj instanceof com.mdss.pos.model.AttendenceHistory)) return false;
		else {
			com.mdss.pos.model.AttendenceHistory attendenceHistory = (com.mdss.pos.model.AttendenceHistory) obj;
