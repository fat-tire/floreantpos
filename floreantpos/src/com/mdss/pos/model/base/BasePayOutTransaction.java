...
public abstract class BasePayOutTransaction extends com.mdss.pos.model.PosTransaction  implements Comparable, Serializable {
	...
	// many to one
	private com.mdss.pos.model.PayoutReason reason;
	private com.mdss.pos.model.PayoutRecepient recepient;
	 ...
	 */
	public com.mdss.pos.model.PayoutReason getReason () {
			return reason;
	}
	 ...
	 */
	public void setReason (com.mdss.pos.model.PayoutReason reason) {
		this.reason = reason;
	}
	 ...
	 */
	public com.mdss.pos.model.PayoutRecepient getRecepient () {
			return recepient;
	}
	 ...
	 */
	public void setRecepient (com.mdss.pos.model.PayoutRecepient recepient) {
	...
	public boolean equals (Object obj) {
		...
		if (!(obj instanceof com.mdss.pos.model.PayOutTransaction)) return false;
		else {
			com.mdss.pos.model.PayOutTransaction payOutTransaction = (com.mdss.pos.model.PayOutTransaction) obj;
