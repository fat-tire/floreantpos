...
public abstract class BaseTicketItemModifierGroup  implements Comparable, Serializable {
	...
	// many to one
	private com.mdss.pos.model.TicketItem parent;

	// collections
	private java.util.List<com.mdss.pos.model.TicketItemModifier> ticketItemModifiers;
	 ...
	 */
	public com.mdss.pos.model.TicketItem getParent () {
			return parent;
	}
	 ...
	 */
	public void setParent (com.mdss.pos.model.TicketItem parent) {
		this.parent = parent;
	}
	 ...
	 */
	public java.util.List<com.mdss.pos.model.TicketItemModifier> getTicketItemModifiers () {
	 ...
	 */
	public void setTicketItemModifiers (java.util.List<com.mdss.pos.model.TicketItemModifier> ticketItemModifiers) {
		this.ticketItemModifiers = ticketItemModifiers;
	}

	public void addToticketItemModifiers (com.mdss.pos.model.TicketItemModifier ticketItemModifier) {
		if (null == getTicketItemModifiers()) setTicketItemModifiers(new java.util.ArrayList<com.mdss.pos.model.TicketItemModifier>());
	...
	public boolean equals (Object obj) {
		...
		if (!(obj instanceof com.mdss.pos.model.TicketItemModifierGroup)) return false;
		else {
			com.mdss.pos.model.TicketItemModifierGroup ticketItemModifierGroup = (com.mdss.pos.model.TicketItemModifierGroup) obj;
