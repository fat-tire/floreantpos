...
public abstract class BaseMenuItem  implements Comparable, Serializable {
	...
	// many to one
	private com.mdss.pos.model.MenuGroup parent;
	private com.mdss.pos.model.Tax tax;

	// collections
	private java.util.List<com.mdss.pos.model.MenuItemShift> shifts;
	private java.util.List<com.mdss.pos.model.MenuItemModifierGroup> menuItemModiferGroups;
	 ...
	 */
	public com.mdss.pos.model.MenuGroup getParent () {
			return parent;
	}
	 ...
	 */
	public void setParent (com.mdss.pos.model.MenuGroup parent) {
		this.parent = parent;
	}
	 ...
	 */
	public com.mdss.pos.model.Tax getTax () {
			return tax;
	}
	 ...
	 */
	public void setTax (com.mdss.pos.model.Tax tax) {
		this.tax = tax;
	}
	 ...
	 */
	public java.util.List<com.mdss.pos.model.MenuItemShift> getShifts () {
			return shifts;
	}
	 ...
	 */
	public void setShifts (java.util.List<com.mdss.pos.model.MenuItemShift> shifts) {
		this.shifts = shifts;
	}

	public void addToshifts (com.mdss.pos.model.MenuItemShift menuItemShift) {
		if (null == getShifts()) setShifts(new java.util.ArrayList<com.mdss.pos.model.MenuItemShift>());
	 ...
	 */
	public java.util.List<com.mdss.pos.model.MenuItemModifierGroup> getMenuItemModiferGroups () {
	 ...
	 */
	public void setMenuItemModiferGroups (java.util.List<com.mdss.pos.model.MenuItemModifierGroup> menuItemModiferGroups) {
		this.menuItemModiferGroups = menuItemModiferGroups;
	}

	public void addTomenuItemModiferGroups (com.mdss.pos.model.MenuItemModifierGroup menuItemModifierGroup) {
		if (null == getMenuItemModiferGroups()) setMenuItemModiferGroups(new java.util.ArrayList<com.mdss.pos.model.MenuItemModifierGroup>());
	...
	public boolean equals (Object obj) {
		...
		if (!(obj instanceof com.mdss.pos.model.MenuItem)) return false;
		else {
			com.mdss.pos.model.MenuItem menuItem = (com.mdss.pos.model.MenuItem) obj;
