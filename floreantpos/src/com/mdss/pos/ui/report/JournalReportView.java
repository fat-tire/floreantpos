...
public class JournalReportView extends JPanel {
		...
		btnGo.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				try {
					...
					POSMessageDialog.showError(JournalReportView.this, POSMessageDialog.ERROR_MESSAGE, e1);
				}
			}
	...
	private void viewReport() throws Exception {
		...
		JasperReport jasperReport = (JasperReport) JRLoader.loadObject(getClass().getResource("/com/mdss/pos/ui/report/journal_report.jasper"));
