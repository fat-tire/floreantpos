...
import com.mdss.pos.report.ReportItem;
import com.mdss.pos.report.SalesReportModel;
...
public class SalesReport extends Report {
	...
	public void refresh() throws Exception {
		...
		JasperReport itemReport = (JasperReport) JRLoader.loadObject(SalesReportModelFactory.class.getResource("/com/mdss/pos/ui/report/sales_sub_report.jasper"));
		JasperReport modifierReport = (JasperReport) JRLoader.loadObject(SalesReportModelFactory.class.getResource("/com/mdss/pos/ui/report/sales_sub_report.jasper"));
		...
		JasperReport masterReport = (JasperReport) JRLoader.loadObject(SalesReport.class.getResource("/com/mdss/pos/ui/report/sales_report.jasper"));
