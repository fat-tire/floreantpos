...
import com.mdss.pos.report.HourlyLaborReportModel;
import com.mdss.pos.report.services.ReportService;
import com.mdss.pos.swing.ListComboBoxModel;
...
public class HourlyLaborReportView extends TransparentPanel {
    ...
    private void viewReport() {
        ...
        try {
            JasperReport hourlyReport = (JasperReport) JRLoader.loadObject(getClass().getResource("/com/mdss/pos/ui/report/hourly_labor_subreport.jasper"));
            JasperReport shiftReport = (JasperReport) JRLoader.loadObject(getClass().getResource("/com/mdss/pos/ui/report/hourly_labor_shift_subreport.jasper"));

            JasperReport report = (JasperReport) JRLoader.loadObject(getClass().getResource("/com/mdss/pos/ui/report/hourly_labor_report.jasper"));

            HashMap properties = new HashMap();
            ReportUtil.populateRestaurantProperties(properties);
            properties.put("reportTitle", "HOURLY LABOR REPORT");
            ...
            properties.put("type", "By Range - Actual");
            properties.put("dept", userType == null ? "All" : userType);
            properties.put("incr", "60 Minute");
            properties.put("cntr", terminal == null ? "ALL" : terminal.getName());
