...
// DO NOT EDIT OR ADD ANY CODE HERE!
    ...
    private void $$$setupUI$$$() {
        ...
        btnDeleteSelected.setIcon(new ImageIcon(getClass().getResource("/images/delete.png")));
        ...
        buttonOK.setIcon(new ImageIcon(getClass().getResource("/images/finish.png")));
        buttonOK.setPreferredSize(new Dimension(120, 50));
        buttonOK.setText(com.floreantpos.POSConstants.OK);
        panel2.add(buttonOK);
        buttonCancel = new PosButton();
        buttonCancel.setIcon(new ImageIcon(getClass().getResource("/images/cancel.png")));
        ...
        btnScrollUp.setIcon(new ImageIcon(getClass().getResource("/images/up.png")));
        ...
        btnScrollDown.setIcon(new ImageIcon(getClass().getResource("/images/down.png")));
