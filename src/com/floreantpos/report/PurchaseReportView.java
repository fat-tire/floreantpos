...
public class PurchaseReportView extends TransparentPanel {
	...
	private void viewReport(List<InventoryItem> inventList) {
		...
		try {
			...
			properties.put("vCompanyName", inventList.get(0).getItemVendor().getName());
			properties.put("vAddress", inventList.get(0).getItemVendor().getAddress());
			properties.put("vCity", inventList.get(0).getItemVendor().getCity());
			properties.put("vPhone", inventList.get(0).getItemVendor().getPhone());
			properties.put("vFax", inventList.get(0).getItemVendor().getFax());
			properties.put("vEmail", inventList.get(0).getItemVendor().getEmail());
	...
	private void $$$setupUI$$$() {
		...
		panel1.add(btnGo, new GridConstraints(0, 0, 1, 1, GridConstraints.ANCHOR_EAST, GridConstraints.FILL_NONE, 1, GridConstraints.SIZEPOLICY_FIXED, null,
