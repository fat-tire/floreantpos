...
public class JRViewerPanel extends JPanel implements JRHyperlinkListener, JRViewerListener {
	...
	protected void refreshPage() {
		...
		Dimension dim = new Dimension((int) (viewerContext.getJasperPrint().getPageWidth() * realZoom) + 8, // 2 from border, 5 from shadow and 1 extra pixel for image
	...
	protected Image getPageErrorImage() {
		Image image = new BufferedImage((int) (viewerContext.getJasperPrint().getPageWidth() * realZoom) + 1, (int) (viewerContext.getJasperPrint()
				.getPageHeight() * realZoom) + 1, BufferedImage.TYPE_INT_RGB);
